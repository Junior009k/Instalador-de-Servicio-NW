...
def sendEmail(server, port, email, password,destinatario, logging, datetime):
    consultaPowershell(f'''
                       $SMTPServer = "{server}"
                       $SMTPPort ={port}
                       $Username = "{email}"
                       $Password = "{password}"
                       $From = "{email}"
                       $To = "{destinatario}"
                       $Subject = "Correo enviado desde el instalador de servicio"
                       $Body = "Configuracion de correo exitosa"
